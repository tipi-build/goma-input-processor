...
TEST_F(CxxCompilerInfoBuilderTest, ParseGetSubprogramsOutputWithAsSuffix) {
  const char kClangOutput[] =
      ...
      "Thread model: posix\n"
      " \"/mnt/scratch0/b_used/build/agent/android_clang_dbg_recipe/build/src/"
      ...
      "\" \"/mnt/scratch0/b_used/build/agent/android_clang_dbg_recipe/build"
      "/src/third_party/llvm-build/Release+Asserts/bin/../lib/clang/3.5.0\" "
      "\"-isystem\" \"/mnt/scratch0/b_used/build/agent/android_clang_dbg_"
      "recipe/build/src/third_party/android_tools/ndk//sources/cxx-stl/"
      "stlport/stlport\" \"-isysroot\" \"/mnt/scratch0/b_used/build/agent/"
      ...
      "b_used/build/agent/android_clang_dbg_recipe/build/src/third_party/"
      "android_tools/ndk//platforms/android-14/arch-arm/usr/local/include"
      "\" \"-internal-isystem\" \"/mnt/scratch0/b_used/build/agent/android_"
      ...
      "scratch0/b_used/build/agent/android_clang_dbg_recipe/build/src/"
      "third_party/android_tools/ndk//platforms/android-14/arch-arm/include"
      "\" \"-internal-externc-isystem\" \"/mnt/scratch0/b_used/build/agent/"
      "android_clang_dbg_recipe/build/src/third_party/android_tools/ndk//"
      "platforms/android-14/arch-arm/usr/include\" \"-Os\" \"-std=gnu++11\" "
      "\"-fdeprecated-macro\" \"-fno-dwarf-directory-asm\" \"-fdebug-"
      "compilation-dir\" \"/mnt/scratch0/b_used/build/agent/android_clang_"
      ...
      "scratch0/b_used/build/agent/android_clang_dbg_recipe/build/src/tools/"
